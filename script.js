...
fetch('bestsellers.json')
  ...
  .then(data => {
    ...
    // Closing Cart and Profile Box


    // Add to cart option

cards.forEach((card, index) => {
  const addToCartButton = card.querySelector('.icon'); // Select the "Add to Cart" button
  const cartText = addToCartButton.querySelector('p'); // Select the text inside the button
